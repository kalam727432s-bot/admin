...
// DELETE /api/form-data/:id → delete 
export async function DELETE(req, { params }) {
  ...
  if(authUser.role !== "admin") {
    ...
    const [formData] = await db.query("SELECT form_code FROM form_data WHERE id = ?", [id]);
  ...
  await db.query("DELETE FROM form_data WHERE id = ?", [id]);
